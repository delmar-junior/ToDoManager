...
import { creatUserOnFirebaseAsync } from '../services/FirebaseApi';
...
export default class Register extends Component {
      ...
      <SafeAreaView style={{ flex: 1 }}>
        <KeyboardAvoidingView style={styles.container} behavior='padding'>
          ...
          <View style={styles.bottomView}>
            ...
            <Button title='Register User' onPress={() => this._createUserAsysnc()} />
          </View>
  ...
  async _createUserAsysnc() {
    try {
      const user = await creatUserOnFirebaseAsync(this.state.email, this.state.password);
